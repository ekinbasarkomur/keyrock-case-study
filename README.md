...
| --- | --- | --- | --- | --- |
| Pair | `--pair` | `KEYROCK_PAIR` | `ethbtc` | Traded pair both the Binance and Bitstamp feeds subscribe to; the gRPC server streams Binance's book for this pair as of step 4 (real merging across both venues is step 5). |
